        ...
        Column{
            ...
            Row{
                ...
                ListView {
                    ...
                    ListModel { id: tabListsModel; ListElement { idx: "0"; names: "船舶标注信息"; } }
                }
            }
            /*-------------------------------------------
             * 中心区域
                                                ...
                                                Item {
                                                    ...
                                                    Row {
                                                        ...
                                                        Text {
                                                            ...
                                                            color: "#eeeeee"; text: mmsi;
                                                        }
                                                        Text {
                                                            anchors.verticalCenter: parent.verticalCenter;
                                                            font{ family: localFont.name; pointSize: 10; bold: false; }
                                                            color: "#eeeeee"; text: mark;
                                                        }
                                                        }
                                                    }
                                                }
                                                        ...
                                                        Row{
                                                            ...
                                                            Row {
                                                                ...
                                                                Text {
                                                                    anchors.verticalCenter: parent.verticalCenter;
                                                                    font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                    color: "#ffffff"; text: "目标名:";
                                                                }
                                                                Text {
                                                                    anchors.verticalCenter: parent.verticalCenter;
                                                                    font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                    color: "#ffffff"; text: shipname;
                                                                }
                                                            }
                                                            Row {
                                                                spacing: 6;
                                                                Text {
                                                                    anchors.verticalCenter: parent.verticalCenter;
                                                                    font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                    color: "#ffffff"; text: "标注类型:"
                                                                }
                                                                Text {
                                                                    anchors.verticalCenter: parent.verticalCenter;
                                                                    font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                    color: "#ffffff"; text: mark;
                                                                }
                                                            }
                                                        }
                                                        Row {
                                                            ...
                                                            Text {
                                                                anchors.verticalCenter: parent.verticalCenter;
                                                                font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                color: "#ffffff"; text: "船舶类型:"
                                                            }
                                                            Text {
                                                                anchors.verticalCenter: parent.verticalCenter;
                                                                font{ family: localFont.name; pointSize: 10; bold: false; }
                                                                color: "#ffffff"; text: shiptype
                                                            }
                                                        }
                                                    }
                                                }
...
//                                                }
                                       ...
                                       // Connections{ target:MarkePanelModel ; onSendClearMarkes: locationModel.clear(); }
                                        Connections{ target:ShipMarkPageModel ; onSendAddMarkeInfo: { locationModel.append( {  "indexs": idx,
                                                                                                                             "shipname": shipnames,
                                                                                                                             "mmsi":mmsis,
                                                                                                                             "imo": imos,
                                                                                                                             "shiptype": shiptypes,
